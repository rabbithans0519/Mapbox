...
(function(){
	...
	renderer.setSize(700, window.innerHeight/1.1);
	...
	controls.position = new THREE.Vector3({x:0,y:0,z:2})
	controls.update();
	...
	bloomPass = new UnrealBloomPass(
		new THREE.Vector2(1301/2, window.innerHeight/2),
		0.5,
		0.4,
		0.85
	);
	...
	frontmaterial = new THREE.ShaderMaterial({
		...
		resolution: {
			value: new THREE.Vector2(700, window.innerHeight/1.1),
		},
		noiseTex: {
			type: "t",
	...
	console.log("sdfsdf:",frontmaterial)
	...
	document.getElementById('hr_line').innerHTML = "<hr>";
